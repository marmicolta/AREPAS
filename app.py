...
with st.container():
    ...
    st.markdown("Model grid generated by [Marbely Micolta](https://sites.google.com/umich.edu/marbelymicolta?usp=sharing) and [Thanawuth Thanathibodee](https://www.frontier.phys.sc.chula.ac.th/thanawut-w).")
